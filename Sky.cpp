...
Sky::Sky(std::shared_ptr<Mesh> mesh, Microsoft::WRL::ComPtr<ID3D11SamplerState> sampleState, Microsoft::WRL::ComPtr<ID3D11PixelShader> skyPixelShader, Microsoft::WRL::ComPtr<ID3D11VertexShader> skyVertexShader, const wchar_t* right, const wchar_t* left, const wchar_t* up, const wchar_t* down, const wchar_t* front, const wchar_t* back)
{
	this->mesh = mesh;
	this->samplerState = sampleState;
	...
	Graphics::Device->CreateDepthStencilState(&dsDesc, depthStencil.GetAddressOf());
